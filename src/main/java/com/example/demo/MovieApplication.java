...
public class MovieApplication {
	...
	@Bean
	public CommandLineRunner bookDemo(MovieRepository movieRepository, GenreRepository genreRepository, UserRepository userRepository) {
		return (args) -> {
			...
			movieRepository.save(new Movie("Star wars: Episode IV  - A New Hope", 1977, genreRepository.findByName("Sci-fi").get(0)));
			movieRepository.save(new Movie("Star wars: Episode V - The Empire Strikes Back", 1980, genreRepository.findByName("Sci-fi").get(0)));	
			movieRepository.save(new Movie("Star wars: Episode VI - Return of the jedi", 1983, genreRepository.findByName("Sci-fi").get(0)));	
			movieRepository.save(new Movie("Interstellar", 2016, genreRepository.findByName("Sci-fi").get(0)));	
